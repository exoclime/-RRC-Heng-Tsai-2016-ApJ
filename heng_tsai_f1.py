...
# choose to play 1a, 1b or 1c (corresponding to the top, middle, and bottom panels in Figure 1.)
plot_fig = '1a'
...
tea_temp = arange(500.0, 3010.0, 100.0)
...
if plot_fig == '1a':
    ...
    print 'Please specify plot_fig ("1a","1b","1c")'    
    
    
temperature = arange(500.0, 3010.0, 10.0)
nt = len(temperature)

if plot_fig == '1a':
    title = r'$P=1$ bar, $\tilde{n}_{\rm C}=2.5\times 10^{-4}$, $\tilde{n}_{\rm O}=5\times 10^{-4}$, $\tilde{n}_{\rm N}=10^{-4}$ (C/O=0.5, N/O=0.2)'
elif plot_fig == '1b':
    title = r'$P=1$ bar, $\tilde{n}_{\rm C}=5\times 10^{-4}$, $\tilde{n}_{\rm O}=5\times 10^{-4}$, $\tilde{n}_{\rm N}=10^{-4}$ (C/O=1, N/O=0.2)'
elif plot_fig == '1c':
    title = r'$P=1$ bar, $\tilde{n}_{\rm C}=2.5\times 10^{-4}$, $\tilde{n}_{\rm O}=5\times 10^{-4}$, $\tilde{n}_{\rm N}=10^{-3}$ (C/O=0.5, N/O=2)'
...
n_c2h4 = zeros(nt)
for i in range(0,nt):
    n_co[i] = n_cmono(n_o,n_c,n_n,temperature[i],pbar)
    n_co_old[i] = n_cmono_old(n_o,n_c,temperature[i],pbar)
    n_h2o[i] = n_water(n_o,n_c,n_n,temperature[i],pbar)
    n_h2o_old[i] = n_water_old(n_o,n_c,temperature[i],pbar)
    n_ch4[i] = n_methane(n_o,n_c,n_n,temperature[i],pbar)
    n_ch4_old[i] = n_methane_old(n_o,n_c,temperature[i],pbar)
    n_nh3[i] = n_ammonia(n_o,n_c,n_n,temperature[i],pbar)
    n_n2[i] = n_nitrogen(n_o,n_c,n_n,temperature[i],pbar)
    n_hcn[i] = n_hcyan(n_o,n_c,n_n,temperature[i],pbar)
    n_co2[i] = n_cdio(n_o,n_c,n_n,temperature[i],pbar)
    n_c2h2[i] = n_acet(n_o,n_c,n_n,temperature[i],pbar)
    n_c2h2_old[i] = n_acet_old(n_o,n_c,temperature[i],pbar)
    n_c2h4[i] = n_ethy(n_o,n_c,n_n,temperature[i],pbar)

# PLOT
line1, =plt.plot(temperature, n_ch4, linewidth=5, color='k', linestyle='--',zorder=0)
line2, =plt.plot(temperature, n_h2o, linewidth=5, color='m', linestyle=':',zorder=0)
line3, =plt.plot(temperature, n_co, linewidth=5, color='c', linestyle='-.',zorder=0)
line4, =plt.plot(temperature, n_nh3, linewidth=5, color='b', linestyle='-',zorder=0)
line5, =plt.plot(temperature, n_n2, linewidth=5, color='b', linestyle=':',zorder=0)
line6, =plt.plot(temperature, n_hcn, linewidth=5, color='r', linestyle='-',zorder=0)
line7, =plt.plot(temperature, n_co2, linewidth=5, color='g', linestyle='--',zorder=0)
line8, =plt.plot(temperature, n_c2h2, linewidth=5, color='y', linestyle='--',zorder=0)
line9, =plt.plot(temperature, n_c2h4, linewidth=5, color='y', linestyle=':',zorder=0)
plt.plot(temperature, n_c2h2_old, linewidth=1, color='y', linestyle='-',zorder=0)
plt.plot(temperature, n_co_old, linewidth=1, color='c', linestyle='-',zorder=0)
plt.plot(temperature, n_ch4_old, linewidth=1, color='k', linestyle='-',zorder=0)
plt.plot(temperature, n_h2o_old, linewidth=1, color='m', linestyle='-',zorder=0)
plt.scatter(tea_temp, tea[:,ch4_col]/tea[:,h2_col], s=40, facecolor='1.', edgecolors='k',zorder=1)
plt.scatter(tea_temp, tea[:,h2o_col]/tea[:,h2_col], s=40, facecolor='m', edgecolors='k',zorder=1)
plt.scatter(tea_temp, tea[:,co_col]/tea[:,h2_col], s=40, facecolor='c', edgecolors='k',zorder=1)
plt.scatter(tea_temp, tea[:,nh3_col]/tea[:,h2_col], s=40, facecolor='b', edgecolors='k',zorder=1)
plt.scatter(tea_temp, tea[:,n2_col]/tea[:,h2_col], s=40, facecolor='b', edgecolors='k',zorder=1)
plt.scatter(tea_temp, tea[:,hcn_col]/tea[:,h2_col], s=40, facecolor='r', edgecolors='k',zorder=1)
plt.scatter(tea_temp, tea[:,co2_col]/tea[:,h2_col], s=40, facecolor='g', edgecolors='k',zorder=1)
plt.scatter(tea_temp, tea[:,c2h2_col]/tea[:,h2_col], s=40, facecolor='y', edgecolors='k',zorder=1)
plt.scatter(tea_temp, tea[:,c2h4_col]/tea[:,h2_col], s=40, facecolor='y', edgecolors='k',zorder=1)
